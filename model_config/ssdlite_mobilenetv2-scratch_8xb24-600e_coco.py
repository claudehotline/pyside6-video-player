...
data_root = 'E:\\Projects\\deeplearning\\data\\COCO-Hand\\COCO-Hand-S'
backend_args = None
metainfo = dict(classes=('hand', ), palettes=[(220, 20, 60)])
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type='CocoDataset',
            data_root=
            'E:\\Projects\\deeplearning\\data\\COCO-Hand\\COCO-Hand-S',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    'E:\\Projects\\deeplearning\\data\\COCO-Hand\\COCO-Hand-S\\annotations\\val.json',
    metric='bbox',
    format_only=False,
    backend_args=None)
test_evaluator = dict(
...
launcher = 'none'
work_dir = 'work_dir/ssdlite_mobilenetv2-scratch_8xb24-600e_coco'
