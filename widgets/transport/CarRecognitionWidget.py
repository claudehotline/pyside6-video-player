...
class CarRecognitionWidget(QWidget):

    start_analysis = Signal()
    
    def __init__(self, parent=None):
        super(CarRecognitionWidget, self).__init__(parent)
        self.ui = Ui_Form()
    ...
    def open_pic_dialog(self):
        ...
        self.videoWidget.videoPlayer.set_player('车辆识别', ['yolov8', 'ckpt.t7'], self.video_path)